Задача проекта:
Изучить основы работы с библиотекой Pandas, научиться анализировать данные и извлекать нужные данные. 
Также расчитывать параметры и необходимые данные из заданной базы данных.
